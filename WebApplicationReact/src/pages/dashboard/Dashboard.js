...
// WebApplicationReact\src\design\public\css\app.css




const DashboardPageN = (props) => {
    return (
        <>
            ...
            <div className="mdk-header-layout js-mdk-header-layout">
                <div id="header"
                    ...
                    <div className="mdk-header__content">
                        ...
                        <div className="navbar navbar-expand pr-0 navbar-dark-pickled-bluewood navbar-shadow"
                            id="default-navbar"
                            data-primary>



                            <button className="navbar-toggler w-auto mr-16pt d-block rounded-0"
                                type="button"
                                data-toggle="sidebar">
                            ...
                            <div className="nav navbar-nav flex-nowrap d-flex mr-16pt">
                                ...
                                <div className="nav-item dropdown dropdown-notifications dropdown-xs-down-full"
                                    data-toggle="tooltip"
                                    data-title="Messages"
                                ...
                                <div className="nav-item ml-16pt dropdown dropdown-notifications dropdown-xs-down-full"
                                    data-toggle="tooltip"
                                ...
                                <div className="nav-item dropdown">
                                    <a href="#"
                                        ...
                                        <span className="avatar avatar-sm mr-8pt2">
                                            ...
                                            <span className="avatar-title rounded-circle bg-primary"><i className="material-icons">account_box</i></span>
